  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-14">
      ...
      <ul className="mt-4 list-disc space-y-2 pl-5 leading-relaxed">
        ...
        <li>Textos originales © 2026 Volar Sin Prisa. Fotos Unsplash con licencia libre; 1 foto “DH 82A Tiger Moth - N81DH” de Towpilot vía Wikimedia Commons bajo CC BY-SA 3.0 y GFDL, con atribución y enlace a licencia.</li>
